        ...
        <tbody>
            {props.tasks.map(task =>
                <tr key={task.id}>
                    ...
                    <td>{ task.done ? <s>{task.apartamento}</s> : task.apartamento }</td>
                    <td>{ task.done ? <s>{task.nome}</s> : task.nome }</td>
                    <td>{ task.done ? <s>{task.qtdeHospede}</s> : task.qtdeHospede }</td>
                    <td>{ task.done ? 
                        <s><Moment format="DD/MM/YYYY">{task.dataCheckin}</Moment></s>
                        : <Moment format="DD/MM/YYYY">{task.dataCheckin}</Moment>
                        }
                    </td>
                    <td>
                        <input
